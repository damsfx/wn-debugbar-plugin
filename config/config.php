...
return [
    ...
    */
    ...
    'collectors' => [
        ...
        'laravel'         => env('DEBUGBAR_COLLECTORS_LARAVEL', false),           // Laravel version and environment
        ...
        'backend'         => env('DEBUGBAR_COLLECTORS_BACKEND', true),            // Current route and AJAX handler info for the Backend module
        'cms'             => env('DEBUGBAR_COLLECTORS_CMS', true),                // Current route, template and AJAX handler info for the CMS module
        'components'      => env('DEBUGBAR_COLLECTORS_COMPONENTS', true),         // CMS component information
    ],
